...
//this.returnSign = function(astroSign) {
		// for (var i = 0; i < $scope.mySign.length; i++) {
  //  		   if ( astroSign === $scope.mySign[i].sign) {
  //   	      show($scope.mySign[i]) 
  //          }
  //      }		
	// 	console.log($scope.mySign)
	// }();
	
	// for (var i = 0; i < $scope.mySign.length; i++) {
	//    		   if (astroSign === mySign[i].sign) {
	//     	      show(signService.mySign[i]) 
	//     	      console.log(signService.mySign[i])
	//            }
	//        }
